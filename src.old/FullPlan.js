...
export default function FullPlan({ navigation, route }) {
    ...
    const handleNext = () => {
      if(choice == 'ai'){
        if(country !== ''){
          navigation.navigate('Famus Places', {country: country});
        } else {
    ...
    <View
      style={{
        ...
        <Image source={require('./assets/headerbgtop.png')} style={{ width: '100%', height: 145, resizeMode: 'contain', position: 'absolute', zIndex: -100 }} />
      ...
      <Image source={require('./assets/footerbg.png')} style={{ width: '100%', height: 135, resizeMode: 'contain', position: 'absolute', zIndex: -100, bottom: 0 }} />
    </View>
  );
}
